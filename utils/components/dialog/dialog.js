...
export default {
    ...
    const component = new Component({
      ...
      methods: {
        ...
        clearPlaceholder(e) {
            ...
            if (type === 'component') {
              this.setData({
                [`$wux.dialog.prompt.placeholder2`]: '',
              })

            } else if (type === 'service') {
              this.setData({
                [`$wux.dialog.prompt.placeholder1`]: '',
              })
            }
        },
        ...
        setPlaceholder(e) {
            ...
            if (type === 'component') {
              this.setData({
                [`$wux.dialog.prompt.placeholder2`]: '面议'
              })
            } else if (type === 'service') {

              this.setData({
                [`$wux.dialog.prompt.placeholder1`]: '面议'
              })
            }
        },
        /**
        ...
        bindinput1(e) {
          ...
          this.setData({
            [`$wux.dialog.prompt.responsename`]: e.detail.value,
          })
        },
        bindinput2(e) {

          this.setData({
            [`$wux.dialog.prompt.responsephone`]: e.detail.value,
          })
        },
        bindinput3(e) {

          this.setData({
            [`$wux.dialog.prompt.servicefee`]: e.detail.value,
          })
        },
        bindinput4(e) {

          this.setData({
            [`$wux.dialog.prompt.componentfee`]: e.detail.value,
          })
        },
      },
    })
  ...
  prompt(opts = {}) {
    const prompt = {
      ...
      responsename: opts.responsename ? opts.responsename : ``,
      responsephone: opts.responsephone ? opts.responsephone : ``,
      servicefee: opts.servicefee ? opts.servicefee : ``,
      componentfee: opts.componentfee ? opts.componentfee : ``,
      placeholder: opts.placeholder ? opts.placeholder : ``,
      placeholder1: opts.placeholder1 ? opts.placeholder1 : ``,
      placeholder2: opts.placeholder2 ? opts.placeholder2 : ``,
